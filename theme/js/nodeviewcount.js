...
jQuery(document).ready(function ($) {
  var nodeviewcount_insert_node_view = function (nid, uid, uip) {
    ...
    $.ajax({
      type: 'POST',
      url: Drupal.settings.basePath + nodeviewcount_path + '/' + nid + '/' + uid + '/' + nodeviewcount_timestamp + '/' + uip +'/'+ nodeviewcount_token,
      dataType: 'json'
    });
  }
  ...
  var nodeviewcount_uip = Drupal.settings.nodeviewcount.nodeviewcount_uip;
